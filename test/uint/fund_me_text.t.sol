...
contract FundMeTest is Test {
    ...
    function testWithdrawWithMultipleFunders() public funded {
        ...
        uint160 staringFundersIndex = 1;
        for (uint160 i = staringFundersIndex; i < numberOfFunders; i++) {
    ...
    function testWithdrawWithMultipleFundersCheck() public funded {
        // Arrange
        uint160 numberOfFunders = 10;
        uint160 staringFundersIndex = 1;
        for (uint160 i = staringFundersIndex; i < numberOfFunders; i++) {
